...
<?php
// Add JavaScript function to handle button click and populate comment input
add_action( 'admin_footer', 'add_openai_javascript_function' );
function add_openai_javascript_function() {
?>
    <script>
